...
function processBlocks(p63, p64, p65, p66, p67)
    ...
    for v102 = p66, p67, 128 do
        ...
        local v151 = v111 + v78;
        v70 = bit32.bor(v110 + v70 + v151 // 4294967296, 0);
        v78 = bit32.bor(v151, 0);
        local v152 = v124 + v79;
        v71 = bit32.bor(v118 + v71 + v152 // 4294967296, 0);
        v79 = bit32.bor(v152, 0);
        local v153 = v116 + v80;
        v72 = bit32.bor(v115 + v72 + v153 // 4294967296, 0);
        v80 = bit32.bor(v153, 0);
        local v154 = v119 + v81;
        v73 = bit32.bor(v114 + v73 + v154 // 4294967296, 0);
        v81 = bit32.bor(v154, 0);
        local v155 = v123 + v82;
        v74 = bit32.bor(v122 + v74 + v155 // 4294967296, 0);
        v82 = bit32.bor(v155, 0);
        local v156 = v109 + v83;
        v75 = bit32.bor(v113 + v75 + v156 // 4294967296, 0);
        v83 = bit32.bor(v156, 0);
        local v157 = v112 + v84;
        v76 = bit32.bor(v120 + v76 + v157 // 4294967296, 0);
        v84 = bit32.bor(v157, 0);
        local v158 = v117 + v85;
        v77 = bit32.bor(v121 + v77 + v158 // 4294967296, 0);
...
local v175 = {
    ...
    BlockSize = 128,
    OutputSize = 48,
    Digest = function(p173) --[[ Name: Digest, Line 348 ]]
        return buffer.tostring(sha384(p173));
    end,
    DigestBuffer = function(p174) --[[ Name: DigestBuffer, Line 351 ]]
        return sha384(buffer.tostring(p174));
    end,
