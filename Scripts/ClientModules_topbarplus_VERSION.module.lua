...
function u1.getLatestVersion() --[[ Line: 14 ]]
    -- upvalues: u1 (copy)
    local l__latestVersion__1 = u1.latestVersion;
    if l__latestVersion__1 then
        return l__latestVersion__1;
    end;
    local v2;
    while true do
        local v3;
        v3, v2 = pcall(function() --[[ Line: 22 ]]
            return game:GetService("MarketplaceService"):GetProductInfoAsync(117501901079852);
        end);
        if v3 and v2 then
            break;
        end;
