...
return function(p1) --[[ Line: 19 ]]
    ...
    local u2 = { "None" };
    for _, v3 in l__ReplicatedStorage__1:WaitForChild("SharedModules"):WaitForChild("MutationData"):GetChildren() do
    ...
    p1:RegisterType("mutationName", {
        Validate = function(p9) --[[ Name: Validate, Line 32 ]]
            -- upvalues: u8 (copy), u2 (copy)
            return u8(p9, true) ~= nil, string.format("%q is not a valid mutation. Valid mutations: %s", p9, table.concat(u2, ", "));
        end,
