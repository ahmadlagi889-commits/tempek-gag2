...
return function(p1) --[[ Line: 19 ]]
    local u2 = {};
    for _, v3 in game.ReplicatedStorage.Assets.Cutscenes:GetChildren() do
    ...
    p1:RegisterType("cutscene", {
        Validate = function(p9) --[[ Name: Validate, Line 29 ]]
            -- upvalues: u8 (copy), u2 (copy)
            return u8(p9, true) ~= nil, string.format("%q is not a valid cutscene. Valid cutscene: %s", p9, table.concat(u2, ", "));
        end,
