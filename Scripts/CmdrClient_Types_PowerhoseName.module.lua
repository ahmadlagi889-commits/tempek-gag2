...
return function(p1) --[[ Line: 17 ]]
    ...
    local u2 = {};
    for _, v3 in require(l__ReplicatedStorage__1:WaitForChild("SharedModules"):WaitForChild("PowerHoseData")).Data do
    ...
    p1:RegisterType("powerHoseName", {
        Validate = function(p9) --[[ Name: Validate, Line 25 ]]
            -- upvalues: u8 (copy), u2 (copy)
            return u8(p9, true) ~= nil, string.format("%q is not a valid PowerHose. Valid PowerHoses: %s", p9, table.concat(u2, ", "));
        end,
