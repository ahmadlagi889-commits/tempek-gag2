...
return {
    ...
    Build1 = function(p86) --[[ Name: Build1, Line 503 ]]
        -- upvalues: u9 (copy)
        for _, v87 in u9 do
            v87:Destroy();
        end;
        p86.FenceOG:Destroy();
        p86.FenceStage1:PivotTo(p86.FenceStage1:GetPivot() * CFrame.new(0, 100, 0));
    end,
    Build2 = function(p88) --[[ Name: Build2, Line 511 ]]
        p88.PlaceInStages["2"]:PivotTo(p88.PlaceInStages["2"]:GetPivot() * CFrame.new(0, 100, 0));
    end,
    Build3 = function(p89) --[[ Name: Build3, Line 517 ]]
        p89.PlaceInStages["3"]:PivotTo(p89.PlaceInStages["3"]:GetPivot() * CFrame.new(0, 100, 0));
    end,
    BuildToNight = function(u90) --[[ Name: BuildToNight, Line 522 ]]
        -- upvalues: u3 (ref)
        u90.PlaceInStages["4"]:PivotTo(u90.PlaceInStages["4"]:GetPivot() * CFrame.new(0, 100, 0));
        local u91 = u90.QuickPlace:GetChildren();
        task.spawn(function() --[[ Line: 531 ]]
            -- upvalues: u91 (copy), u3 (ref), u90 (copy)
            for v92, v93 in u91 do
                v93:PivotTo(v93:GetPivot() * CFrame.new(0, 100, 0));
                local v94 = (1 - (1 - (v92 + 1) / #u91) ^ 2) * 4 - (1 - (1 - v92 / #u91) ^ 2) * 4;
                u3.WorldPosition = v93:GetPivot().p;
                for _, v95 in u3:GetChildren() do
                    v95:Emit(v95:GetAttribute("EmitCount") or 1);
                end;
                task.wait(v94);
            end;
            task.delay(4, function() --[[ Line: 552 ]]
                -- upvalues: u90 (ref)
                u90.Fruits["5"].Destroy1:Destroy();
                u90.Fruits["6"].Destroy2:Destroy();
                u90.PlaceInStages["3"].DestroyMe:Destroy();
                u90.PlaceInStages["3"].DestroyMe2:Destroy();
            end);
        end);
        game.Lighting.GeographicLatitude = 24;
        local v96 = 0;
        while v96 < 4 do
            ...
            game.Lighting.ClockTime = lerp(14, 6, v96 / 4);
        end;
    end,
    Sweat = function(p97) --[[ Name: Sweat, Line 576 ]]
        -- upvalues: l__BodyShaker__3 (copy)
        p97.Rigs.Thief.Head.Sweat.Enabled = true;
        l__BodyShaker__3.EnableShaking(p97.Rigs.Thief);
    end,
    Poof = function(p98) --[[ Name: Poof, Line 584 ]]
        -- upvalues: l__BodyShaker__3 (copy), l__CamShake__2 (copy)
        l__BodyShaker__3.DisableShaking(p98.Rigs.Thief);
        p98.VFX.Poof.PixelSmoke:Emit(18);
        l__CamShake__2:Shake(l__CamShake__2.Presets.Bump);
    end,
    GAG2 = function(_) --[[ Name: GAG2, Line 590 ]]
        -- upvalues: u1 (ref)
        ...
        task.delay(4, function() --[[ Line: 601 ]]
            -- upvalues: u1 (ref)
    ...
    EndState = function(p99) --[[ Name: EndState, Line 611 ]]
