...
function processBlocks(p3, p4, p5, p6)
    ...
    for v25 = p5, p6, 64 do
        ...
        v10 = bit32.bor(v10 + v36, 0);
        v11 = bit32.bor(v11 + v43, 0);
        v12 = bit32.bor(v12 + v41, 0);
        v13 = bit32.bor(v13 + v39, 0);
        v14 = bit32.bor(v14 + v40, 0);
        v15 = bit32.bor(v15 + v42, 0);
    end;
    p3[1] = v8;
    p3[2] = v9;
    p3[3] = v10;
...
local v77 = {
    ...
    BlockSize = 64,
    OutputSize = 28,
    Digest = function(p75) --[[ Name: Digest, Line 172 ]]
        return buffer.tostring(sha224(p75));
    end,
    DigestBuffer = function(p76) --[[ Name: DigestBuffer, Line 175 ]]
        return sha224(buffer.tostring(p76));
    end,
