...
function v1.ApplyMutationEffect(u4) --[[ Line: 63 ]]
    ...
    if u4:IsA("Model") and (u4.PrimaryPart and (not u2[u4] and (u4:IsA("Model") and u4.PrimaryPart))) then
        l__GrowEffects__1.AddDescendantsAtBaseline(u4, function() --[[ Line: 26 ]]
    ...
    u4.DescendantAdded:Connect(function(p11) --[[ Line: 76 ]]
