...
return function(u1) --[[ Line: 44 ]]
    ...
    local function u31(_) --[[ Line: 133 ]]
        ...
        if l__Character__10 then
            ...
            if u18 and u19 then
                ...
                local v25 = v24 * 5 * v22 + Vector3.new(0, v22 * 16, 0);
    ...
    local u59 = l__Networking__4.Seesaw.SeatChanged.OnClientEvent:Connect(function(p40, p41, p42, p43, u44) --[[ Line: 274 ]]
    ...
    local u66 = u14;
    for u67 = 1, 2 do
        u7[u67].Touched:Connect(function(p68) --[[ Line: 312 ]]
    ...
    u39();
    l__LocalPlayer__3.CharacterAdded:Connect(function() --[[ Line: 333 ]]
        -- upvalues: u39 (copy)
        task.wait();
        u39();
    end);
    u1.Destroying:Connect(function() --[[ Line: 339 ]]
        -- upvalues: u3 (ref), u66 (ref), u10 (copy), l__LocalPlayer__3 (ref), u9 (copy), u61 (ref), u64 (ref), l__ATT1__9 (copy), l__TargetTilt__7 (copy), u2 (copy), u62 (ref), u63 (ref), u60 (ref), u59 (copy), u65 (ref)
        u3 = true;
        if u66 then
            task.cancel(u66);
            u66 = nil;
