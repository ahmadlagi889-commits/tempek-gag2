...
return function(u1) --[[ Line: 44 ]]
    ...
    local function u31(_) --[[ Line: 133 ]]
        ...
        if l__Character__10 then
            ...
            if u18 and u19 then
                ...
                local v22 = math.lerp(1.25, 18.75, v21);
                ...
                local v25 = v24 * 6.25 * v22 + Vector3.new(0, v22 * 20, 0);
    ...
    u39();
    l__LocalPlayer__3.CharacterAdded:Connect(function() --[[ Line: 329 ]]
        -- upvalues: u39 (copy)
        task.wait();
        u39();
    end);
    u1.Destroying:Connect(function() --[[ Line: 334 ]]
        -- upvalues: u3 (ref), u66 (ref), u10 (copy), l__LocalPlayer__3 (ref), u9 (copy), u62 (ref), u65 (ref), l__ATT1__9 (copy), l__TargetTilt__7 (copy), u2 (copy), u63 (ref), u64 (ref), u61 (ref), u59 (copy), u60 (ref)
        u3 = true;
        if u66 then
            task.cancel(u66);
            u66 = nil;
