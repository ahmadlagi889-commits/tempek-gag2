...
function u3.__index.AddPromise(p14, u15) --[[ Line: 124 ]]
    ...
    local v20 = p14:Add(v16.new(function(p18, _, p19) --[[ Line: 132 ]]
        -- upvalues: u15 (copy)
        if p19(function() --[[ Line: 133 ]]
            -- upvalues: u15 (ref)
            u15:cancel();
        end) then
        else
...
function u3.__index.AddObject(p21, p22) --[[ Line: 154 ]]
    -- upvalues: l__RunService__1 (copy)
...
function u3.__index.Remove(p26, p27) --[[ Line: 177 ]]
    -- upvalues: u1 (copy)
    local v28 = p26[u1];
...
function u3.__index.Get(p32, p33) --[[ Line: 211 ]]
    -- upvalues: u1 (copy)
    local v34 = p32[u1];
    if v34 then
        return v34[p33];
...
function u3.__index.Cleanup(p35) --[[ Line: 222 ]]
    -- upvalues: u1 (copy)
...
function u3.__index.Destroy(p46) --[[ Line: 281 ]]
    p46:Cleanup();
end;
...
u47.__index = u47;
function u47.Disconnect(p48) --[[ Line: 295 ]]
    if p48.Connected then
        p48.Connected = false;
        p48.Connection:Disconnect();
    end;
end;
function u47.__tostring(p49) --[[ Line: 302 ]]
    return "Disconnect<" .. tostring(p49.Connected) .. ">";
end;
function u3.__index.LinkToInstance(u50, p51, p52) --[[ Line: 312 ]]
    -- upvalues: u2 (copy), u47 (copy), l__Heartbeat__2 (copy)
    local u53 = nil;
    local v54 = p52 and newproxy(false) or u2;
    local u55 = p51.Parent == nil;
    local u56 = setmetatable({}, u47);
    local u58 = p51.AncestryChanged:Connect(function(_, p57) --[[ Name: ChangedFunction, Line 318 ]]
        -- upvalues: u56 (copy), u55 (ref), l__Heartbeat__2 (ref), u53 (ref), u50 (copy)
        u55 = u56.Connected and p57 == nil;
        if u55 then
            coroutine.wrap(function() --[[ Line: 324 ]]
                -- upvalues: l__Heartbeat__2 (ref), u56 (ref), u53 (ref), u50 (ref), u55 (ref)
    ...
    if u55 then
        ...
        if u56.Connected then
            ...
            if u55 then
                coroutine.wrap(function() --[[ Line: 324 ]]
                    -- upvalues: l__Heartbeat__2 (ref), u56 (copy), u58 (ref), u50 (copy), u55 (ref)
                    l__Heartbeat__2:Wait();
                    if u56.Connected then
...
function u3.__index.LinkToInstances(p59, ...) --[[ Line: 360 ]]
    -- upvalues: u3 (copy)
    local v60 = u3.new();
