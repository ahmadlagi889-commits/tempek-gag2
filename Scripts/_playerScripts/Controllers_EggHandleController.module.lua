...
local l__Eggs__4 = l__ReplicatedStorage__2:WaitForChild("Assets"):WaitForChild("Eggs");
...
function v1.Init(_) --[[ Line: 26 ]] end;
function v1.Start(u9) --[[ Line: 29 ]]
    -- upvalues: l__Players__1 (copy), u2 (copy)
    for _, v10 in l__Players__1:GetPlayers() do
        u9:SetupPlayer(v10);
    end;
    l__Players__1.PlayerAdded:Connect(function(p11) --[[ Line: 34 ]]
        -- upvalues: u9 (copy)
        u9:SetupPlayer(p11);
    end);
    l__Players__1.PlayerRemoving:Connect(function(p12) --[[ Line: 38 ]]
...
function v1.PreparePartForTool(_, p15) --[[ Line: 49 ]]
    p15.Anchored = false;
    p15.CanCollide = false;
    p15.CanQuery = false;
    p15.CanTouch = false;
end;
function v1.DisableVFX(_, p16) --[[ Line: 56 ]]
...
function v1.ClearVisual(_, p18) --[[ Line: 68 ]]
    for _, u19 in p18:GetChildren() do
        if u19:GetAttribute("_EggVisual") then
            u19.Parent = nil;
...
function v1.HasVisual(_, p20) --[[ Line: 81 ]]
    for _, v21 in p20:GetChildren() do
        if v21:GetAttribute("_EggVisual") then
            return true;
        end;
    end;
    return false;
end;
function v1.SpawnHandle(p22, p23, p24) --[[ Line: 90 ]]
    -- upvalues: u4 (copy), l__Eggs__4 (copy), l__LocalPlayer__6 (copy), u7 (copy), u8 (copy)
    if u4[p23] then
    else
        u4[p23] = true;
        p22:ClearVisual(p23);
        ...
        if v25 then
            ...
            if v26 then
                local v27 = p23:GetAttribute("Egg");
                if v27 then
                    local v28 = l__Eggs__4:FindFirstChild(v27);
                    if v28 then
                        local v29 = v28:Clone();
                        p22:DisableVFX(v29);
                        ...
                        if v30 then
                            ...
                            v32.Part1 = v25;
                            v32.Parent = v30;
                            v29:SetAttribute("_EggVisual", true);
                            v29.Parent = p23;
                            local v33 = l__LocalPlayer__6;
                            if v33 then
                                v33 = l__LocalPlayer__6.Character == p24;
                            end;
                            if v33 then
                                p23.Grip = u7;
                            else
...
function v1.UpdateToolState(p35, p36) --[[ Line: 159 ]]
...
function v1.DisconnectTool(_, p40) --[[ Line: 175 ]]
...
function v1.CleanupTool(p43, p44) --[[ Line: 187 ]]
    p43:ClearVisual(p44);
    p43:DisconnectTool(p44);
end;
function v1.IsTrackedTool(_, p45) --[[ Line: 192 ]]
    return p45:GetAttribute("Egg") ~= nil;
end;
function v1.SetupTool(u46, u47, p48) --[[ Line: 196 ]]
    -- upvalues: u3 (copy), l__LocalPlayer__6 (copy), u5 (ref), l__Networking__3 (copy), u6 (ref), u2 (copy)
    u46:DisconnectTool(u47);
    local v49 = {};
    u3[u47] = p48;
    local v50 = u47:GetPropertyChangedSignal("Parent");
    table.insert(v49, v50:Connect(function() --[[ Line: 202 ]]
    ...
    local function u54(u51) --[[ Line: 210 ]]
        -- upvalues: l__LocalPlayer__6 (ref), u5 (ref), l__Networking__3 (ref)
        if l__LocalPlayer__6:GetAttribute("LoadingScreenActive") then
            return false;
        end;
        if u5 then
            return false;
        ...
        u5 = true;
        local v53, v53 = pcall(function() --[[ Line: 215 ]]
            -- upvalues: l__Networking__3 (ref), u51 (copy)
            return l__Networking__3.Egg.OpenEgg:Fire(u51);
        end);
        if not v53 then
            warn((`[EggHandleController] OpenEgg invoke errored ({u51}): {v53}`));
        end;
        u5 = false;
        if v53 then
            if v53 then
                v53 = v53.Success == true;
            end;
        end;
        return v53;
    end;
    table.insert(v49, u47.Activated:Connect(function() --[[ Line: 226 ]]
        -- upvalues: u47 (copy), u6 (ref), u54 (copy)
        local v55 = u47:GetAttribute("Egg");
        ...
        while u6 do
            local v57 = u47:GetAttribute("Egg");
    ...
    table.insert(v49, u47.Deactivated:Connect(function() --[[ Line: 257 ]]
        -- upvalues: u6 (ref)
        u6 = false;
    end));
    u2[u47] = v49;
...
function v1.SetupCharacter(u59, u60) --[[ Line: 270 ]]
    ...
    task.defer(function() --[[ Line: 271 ]]
        ...
        if u60 and u60.Parent then
            ...
            u60.ChildAdded:Connect(function(u64) --[[ Line: 289 ]]
...
function v1.SetupPlayer(u65, u66) --[[ Line: 301 ]]
    -- upvalues: l__BackpackListener__5 (copy)
    if u66.Character then
        u65:SetupCharacter(u66.Character);
    end;
    u66.CharacterAdded:Connect(function(p67) --[[ Line: 306 ]]
        -- upvalues: u65 (copy)
        u65:SetupCharacter(p67);
    end);
    l__BackpackListener__5.bind(u66, function(u68) --[[ Line: 310 ]]
        ...
        if u68:IsA("Tool") and u65:IsTrackedTool(u68) then
            task.defer(function() --[[ Line: 312 ]]
                ...
                local l__Character__7 = u66.Character;
                if u68 and (u68.Parent and (l__Character__7 and l__Character__7.Parent)) then
                    u65:SetupTool(u68, l__Character__7);
                end;
            end);
        end;
    end);
