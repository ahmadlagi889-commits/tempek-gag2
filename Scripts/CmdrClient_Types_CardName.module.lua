...
local function u5() --[[ Line: 4 ]]
    ...
    local v1 = l__ReplicatedStorage__2:FindFirstChild("Modules"):FindFirstChild("Card_Inventory_MODULE");
    local v2 = require(v1:FindFirstChild("CardData"));
    local v3 = {};
...
local u11 = {
    ...
    Validate = function(p8) --[[ Name: Validate, Line 24 ]]
        return #p8 > 0, "No card with that name could be found.";
    end,
